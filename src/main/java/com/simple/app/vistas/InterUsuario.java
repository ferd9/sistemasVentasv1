...
public class InterUsuario extends javax.swing.JInternalFrame {
    ...
    private void jButton_GuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_GuardarActionPerformed
        if (txt_nombre.getText().isEmpty() ||
            ...
            if (!usuarioJpaController.isExisteUsuario(txt_usuario.getText())) {
                //enviamos datos del usuario
                usuarioJpaController.close();
                usuario.setNombre(txt_nombre.getText().trim());
                usuario.setApellido(txt_apellido.getText().trim());
                usuario.setUsuario(txt_usuario.getText().trim());
                usuario.setPassword(String.valueOf(txt_password.getPassword()).trim());
                ...
                try {
                    ...
                    Logger.getLogger(InterUsuario.class.getName()).log(Level.SEVERE, null, ex);
                }
