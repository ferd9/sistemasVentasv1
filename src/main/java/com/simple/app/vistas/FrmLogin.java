...
public class FrmLogin extends javax.swing.JFrame {
    ...
    public Image getIconImage() {
        Image retValue = Toolkit.getDefaultToolkit().getImage(ClassLoader.getSystemResource("com/simple/app/img/ventas.png"));
        return retValue;
    }*/
    ...
    private void Login() {
        ...
        Usuario usuario = usuarioJpaController.findUsuario(txt_usuario.getText().trim(), String.valueOf(txt_password.getPassword()));
        if(usuario == null){
